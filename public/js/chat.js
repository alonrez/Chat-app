...
$messageFormButton.setAttribute('disabled', 'disabled') // disable the send buttoon for a sec
    ...
    socket.emit('sendMessage', message, (error) => {
        ...
        $messageFormButton.removeAttribute('disabled')   // reEnable the send button 
